            ...
            <div class="offset-md-2 col-lg-5 col-md-7 offset-lg-4 offset-md-3">
                <div class="panel border bg-white">
                    <div class="panel-heading">
                        <h3 cl  ass="pt-3 font-weight-bold">Đổi mật khẩu</h3>
                    </div>
                    <div class="panel-body p-3">
                        <form action="index.php?act=doimk" method="POST">
                            ...
                            <div class="form-group py-1 pb-2">
                                <div class="input-field"> <span class="fas fa-lock px-2"></span> <input type="password" placeholder="Mật khẩu cũ" name="passcu" required> <button class="btn bg-white text-muted"> <span class="far fa-eye-slash"></span> </button> </div>
                            </div>
                            <div class="form-group py-1 pb-2">
                                <div class="input-field"> <span class="fas fa-lock px-2"></span> <input type="password" placeholder="Mật khẩu mới" name="passmoi" required> <button class="btn bg-white text-muted"> <span class="far fa-eye-slash"></span> </button> </div>
                            </div>
                            
                          
                             <input class="btn btn-primary btn-block mt-3"  type="submit" value="Đổi mật khẩu" name="doimk">
                        </form>
                        <?php 
